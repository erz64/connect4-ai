...
class TestGameBoard(unittest.TestCase):
    ...
    def test_check_vertical_win(self):
        ...
        self.assertEqual(self.board._check_vertical_win(0, 2, "red", self.board.pieces), True)
    ...
    def test_check_horizontal_win(self):
        ...
        self.assertEqual(self.board._check_horizontal_win(3, 5, "red", self.board.pieces), True)
    ...
    def test_check_diagonal_win_left_to_right(self):
        ...
        self.assertEqual(self.board._check_diagonal_win_left_to_right(3, 2, "red", self.board.pieces), True)
    ...
    def test_check_diagonal_win_right_to_left(self):
        ...
        self.board.place_piece(3, 2, "red", self.board.pieces)
        self.assertEqual(self.board._check_diagonal_win_right_to_left(3, 2, "red", self.board.pieces), True)
